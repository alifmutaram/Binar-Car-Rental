...
const DetailCar = () => {
  ...
  return (
    <div className="detail-car">
      ...
      <div className="card d-flex flex-column detail-paket-side">
        <img
        ...
        />
        <div
          className="card-body d-flex flex-column align-items-baseline"
          style={{ padding: '0' }}
        >
          <h4 className="card-title">{detailCar.name}</h4>
          <p
            className="card-text"
